...
function FinalSummary() {
  ...
  const handleDownloadResults = () => {
    ...
    const resultsText = `
AUTOMATED HIRING SYSTEM - TALENT ASSESSMENT RESULTS
...
© 2025 All Rights Reserved
    ...
    a.href = url;
    a.download = `${state.userInfo.name}_Talent_Assessment.txt`;
  ...
  const handleShareResults = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: 'My Talent Assessment Results',
        text: `I just completed a comprehensive talent assessment! ${finalSummary.substring(0, 100)}...`,
  ...
  if (loading) {
    return <LoadingPage message="Finalizing your comprehensive talent assessment..." />;
  }
          ...
          <Card sx={{ mb: 4, borderRadius: 3, background: 'linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%)' }}>
            <CardContent sx={{ textAlign: 'center', py: 6 }}>
              ...
              <Typography variant="h6" color="text.secondary" sx={{ mb: 3 }}>
                Congratulations, {state.userInfo.name}! Your comprehensive talent profile is ready.
              </Typography>
            ...
            <motion.div variants={itemVariants}>
              <Card sx={{ mb: 4, borderRadius: 3, boxShadow: 3, maxWidth: '800px', mx: 'auto' }}>
                <CardContent sx={{ p: 4 }}>
                  ...
                  >
                    {finalSummary || "Analyzing your comprehensive talent profile..."}
                  </Typography>
